...
// StrictServerInterface methods (VM CRUD, added Milestone 4) so realHandler
// below satisfies the full interface without pulling in
// internal/handlers/vm or internal/vm — this package's tests exercise only
// Cluster CRUD.
type stubVM struct{}
