...
| **Total** | 11 | 6 | **29** | Phase 1 has 4 planned runtime/static checks and two integration-tier-sufficient failure branches; Phase 2 has 6 implemented runtime checks, including Hub dispatch through the pinned `v0.0.107` CLI. |
