...
| 4.2 OSAC Client Bootstrap | 11 | 16 | 4 dedicated (TC-I-015, TC-I-017, TC-I-032, TC-I-033) + covered via Health tests (TC-I-010..014) | Real `bufconn` dial path and real discovery-document fetch exercised only here; RFC 8414/OIDC fallback ordering itself is unit-test scope (TC-U-023..025). TC-I-032/033 verify DD-229's TLS enforcement: certificate validation rejection and no plaintext fallback. |
