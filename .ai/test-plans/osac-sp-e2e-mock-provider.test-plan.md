...
| `Clusters.GetKubeconfig` / `ClusterTemplates` | REQ-MOCK-120, 130 | AC-MOCK-130, 140 | 2 (TC-U-155..156) | — | Both added post-hoc as regression tests for real gaps found while validating M3/M4's e2e coverage against a combined branch (DD-145, and this branch's own `ClusterTemplates` addition). |
| **Total** | 11 | 12 | **39** | **1** | |
